...
// Viết đánh giá + danh sách đánh giá của món ăn
          ...
          children: [
            ...
            if (canReview) ...[
              ...
              const SizedBox(height: 24),
                ...
                !ReviewProvider.hasPurchasedFood(
                    widget.food.id, orderProvider.orders)) ...[
              Container(
                width: double.infinity,
                ...
                child: const Text(
                  'Bạn chỉ có thể đánh giá sau khi đã mua món này.',
